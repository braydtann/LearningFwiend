                                    ...
                                    <CardContent className="p-4">
                                      ...
                                      {question.type === 'chronological-order' && (
                                        <div className="space-y-4 mb-4">
                                                ...
                                                <div className="flex items-center justify-between mb-2">
                                                  <div className="flex items-center space-x-2">
                                                    ...
                                                    <span className="text-sm text-gray-600">
                                                      (Position {itemIndex + 1} in correct order)
                                                    </span>
                                                  </div>
                                          ...
                                          {question.items && question.items.length > 0 && (
                                            <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                                              <p className="text-orange-800 text-sm font-medium mb-1">
                                                📝 Correct Order: Items {question.items.length > 1 ? `1 → ${question.items.length}` : '1'}
                                              </p>
                                              <p className="text-orange-700 text-xs">
                                                Items are listed in the correct chronological order. Students will see them shuffled and must arrange them correctly.
                                              </p>
                                            </div>
                                          )}
                                          ...
                                          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                            <p className="text-blue-800 text-sm">
                                              💡 <strong>Tip:</strong> Add items in the correct chronological order. Students will see them shuffled and must arrange them correctly.
                                            </p>
                                          </div>
                                        </div>
                                      )}
